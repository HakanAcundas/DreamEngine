...
{
  std::shared_ptr<Shader> shader = std::make_shared<Shader>("../DreamTest/shaders/vertex.shader", "../DreamTest/shaders/fragment.shader");
  std::shared_ptr<Camera> camera = std::make_shared<Camera>(0.0f, 16.0f, 0.0f, 9.0f);
